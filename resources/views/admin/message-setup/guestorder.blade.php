        ...
        <table class="table" width="100%" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><b style="font-size: 15px;">{{ $products->sum('sub_total_price') }}</b></td>
                </tr>
                <tr>
                    <td>Ref Num: </td>
                    <td colspan="5"><strong>{{@$data->ref_id}}</strong></td>
                </tr>
            </tbody>
        </table>
        <a href="{{ route('user-order-detail-pdfs', @$data->ref_id) }}" class="btns">Downlaod Pdf</a>
    @endif
</body>
    ...
    <div class="similar-table table-first">
        <table>
            <tbody>
                ...
                <tr>
                    <td colspan="3"><b>{{ucfirst(@$msg)}}!</b></td>
                </tr>
                ...
                <tr>
                    <td colspan="3" class="btns-track"><a href="{{route('index')}}">Track My Order</a></td>
                </tr>
            </tbody>
        </table>
    </div>
    <div class="similar-table table-second">
        <table>
            <tbody>
                ...
                <tr>
                    <td>Address:</td>
                    <td>{{@$data->province}},{{@$data->district}},{{@$data->area}},{{@$data->additional_address}}
                    </td>
                </tr>
                <tr>
                    <td>Phone:</td>
    ...
    <div class="similar-table table-third">
        <table>
            <tbody>
                ...
                @foreach($data->orderAssets as $key=>$product)
    ...
    <div class="similar-table table-fourth">
        <table>
            <tbody>
                ...
                <tr>
                    <td>Delivery Fee:</td>
                    <td style="text-align:right;">$. {{@$data->shipping_charge}}</td>
                </tr>
                <tr>
                    <td>Total Discount:</td>
                    <td style="text-align:right;">$. {{@$data->total_discount}}</td>
                </tr>
                {{-- <tr>
                    <td style="padding-bottom:30px;font-weight:bold;font-size:20px;">Total Payment (VAT Incl):</td>
                    <td style="padding-bottom:30px;font-weight:bold;font-size:20px;color:#e62e04;text-align:right;">$. 1250</td>
                </tr> --}}
                <tr>
                ...
                <tr>
                    <td>Paid By:</td>
                    <td style="text-align:right;">{{@$data->payment_with}}</td>
                </tr>
                <tr>
                                ...
                                @if ($social_link->title == 'facebook' || $social_link->title == 'Facebook' || $social_link->title == 'FACEBOOK')
                                    <li>
                                        <a href="{{ $social_link->url }}" class="facebook" target="_blank"
                                            title="{{ $social_link->title }}"><img src="{{asset('frontend/images/facebook.png')}}"></a>
                                    </li>
                                @elseif ($social_link->title == 'instagram' || $social_link->title == 'Instagram' || $social_link->title == 'INSTAGRAM')
                                    <li>
                                        <a href="{{ $social_link->url }}" class="facebook" target="_blank"
                                            title="{{ $social_link->title }}"><img src="{{asset('frontend/images/instagram.png')}}"></a>
                                    </li>
                                @elseif ($social_link->title == 'twitter' || $social_link->title == 'Twitter' || $social_link->title == 'TWITTER')
                                    <li>
                                        <a href="{{ $social_link->url }}" class="twitter" target="_blank"
                                            title="{{ $social_link->title }}"><img src="{{asset('frontend/images/twitter.png')}}"></a>
                                    </li>
                                @elseif ($social_link->title == 'youtube' || $social_link->title == 'Youtube' || $social_link->title == 'YOUTUBE')
                                    <li>
                                        <a href="{{ $social_link->url }}" class="youtube" target="_blank"
                                            title="{{ $social_link->title }}"><img src="{{asset('frontend/images/youtube.png')}}"></a>
                                    </li>
                                @else
                                    <li>
                                        <a href="{{ $social_link->url }}" class="youtube" target="_blank"
