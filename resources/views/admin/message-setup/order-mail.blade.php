        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3" class="btns-track"><a href="{{route('mailtrack',[@$order->ref_id,@$customer->email])}}">Track My Order</a></td>
                </tr>
            </tbody>
        </table>
    </div>
    <div class="similar-table table-second">
        <table>
            <tbody>
                ...
                <tr>
                    <td>Address:</td>
                    <td>{{@$order->getprovince->eng_name ?? ''}},{{@$order->getDistrict->np_name ?? ''}},{{@$order->area}},{{@$order->additional_address}}
                    </td>
                </tr>
                <tr>
                    <td>Phone Number:</td>
