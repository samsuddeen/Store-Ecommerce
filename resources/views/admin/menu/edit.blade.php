                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>
                                        @foreach ($show_on as $index => $show)
                                            <input class="form-check-input menu-type ms-2" type="radio"
                            ...
                            <div class="col-xl-4 col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea type="text" name="meta_keywords" class="form-control" rows="3">{{ old('meta_keywords', @$menu->meta_keywords) }}</textarea>
                                    @error('meta_keywords')
                                        <p class="form-control-static text-danger" id="staticInput">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4 col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea type="text" name="meta_description" class="form-control" rows="3">{{ old('meta_description', @$menu->meta_description) }}</textarea>
...
<script src="{{ asset('js/ck-editor/build/ckeditor.js') }}"></script>
    ...
    <script>
        ...
        getContentAtFirst("{{ @$menu->menu_type }}");
        ...
        function getContentAtFirst(menu_type) {
            $.ajax({
                url: "/admin/get-menu-type-content",
                type: 'get',
                data: {
