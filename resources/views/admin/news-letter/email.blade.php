                    ...
                    <tr>
                        <td class="temp-wrapper"
                            ...
                            <div align="center">
                                ...
                                <div class="temp-body"
                                    style="background-color:#ffffff; border-radius:10px; max-width: 600px; margin:60px 16px 200px; 
    padding: 16px;">
                                        ...
                                        <div class="region">
                                            <div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="container"
                                                            style="padding: 0px; width: 100%; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Tahoma, Arial, sans-serif; border-collapse: collapse;
border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center"
                                                                                    ...
                                                                                    <img class="model"
                                                                                        src="https://celermart.nectar.com.np/storage/photos/Group%2047203@2x_1.png"
                                                                                        style="display: block; width: 60px; height: 60px; border-width: 0px; border-style: none; line-height: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 10px;"
                                                                                        alt="{{ $title }}"
                                                                                        width="600"
                                                                                        height="283">
                                                                                </td>
...
border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;"
                                                ...
                                                <table class="row aw-stack"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="container"
                                                                style="padding: 30px; width: 100%; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Tahoma, Arial, sans-serif; border-collapse:
collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;"
                                                                width="100%" valign="top">
                                                                <div class="definition-parent">
                                                                    <div class="text-element paragraph">
                                                                        <div
                                                                            style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">

                                                                            <p
                                                                                style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 19px; line-height: 125%; font-weight: 400; text-align: center;">
                                                                                {!! $description !!}
