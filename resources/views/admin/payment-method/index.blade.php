@extends('layouts.app')
@section('title', env('DEFAULT_TITLE') . ' | ' . 'Payment Method')
@section('content')
    <!-- brand start -->
    <section class="app-user-list">

        <div class="card">
            <x-cardHeader :href="route('payment-method.create')" name="Payment Methods" />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5 mx-50 pb-5">
                    ...
                    <form class="row gy-1 gx-2 mt-75" method="post" action="{{route('payment-method.status')}}">
                        @csrf
                        @method("PATCH")
                        <input type="text" name="status" id="status-input" hidden>
                        <input type="text" name="payment_id" id="payment_id-input" hidden>
...
<script>
    ...
    <script src="{{ asset('admin/payment-method-list.js') }}" defer></script>
@endpush
