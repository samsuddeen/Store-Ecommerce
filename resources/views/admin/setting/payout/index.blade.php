...
@section('content')
    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <x-cardHeader :href="route('payout-setting.create')" name="Payout Period" />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5 mx-50 pb-5">
                    ...
                    <form class="row gy-1 gx-2 mt-75" method="post" action="{{route('payout-setting.status')}}">
                        @csrf
                        @method("PATCH")
...
<script>
    ...
    <script src="{{ asset('admin/payout-setting-list.js') }}" defer></script>
@endpush
