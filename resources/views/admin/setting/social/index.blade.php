...
@section('content')
    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <x-cardHeader :href="route('social-setting.create')" name="Social Media" />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5 mx-50 pb-5">
                    ...
                    <form class="row gy-1 gx-2 mt-75" method="post" action="{{ route('social-setting.status') }}">
                        @csrf
                        @method('PATCH')
                        <input type="text" name="status" id="status-input" hidden>
                        <input type="text" name="social_setting_id" id="payment_id-input" hidden>
...
@push('script')
    ...
    <script src="{{ asset('admin/social-setting-list.js') }}" defer></script>
@endpush
