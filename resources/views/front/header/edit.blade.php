            ...
            <div class="ibox-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-7-1">
                                ...
                                <form method="POST" action="{{route ("header.update")}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" rows="5" name="title" class="form-control"
                                            class="@error('title') is-valid @enderror" placeholder="Enter  title"value="{{$header->title}}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="icon_image" class="form-control"
                                            class="@error('icon_image') is-valid @enderror"value="{{@old('icon_image')}}"" />
                        ...
                        <a class="btn btn-warning" href="{{ url('header/') }}">Cancel</a>
                        </form>
