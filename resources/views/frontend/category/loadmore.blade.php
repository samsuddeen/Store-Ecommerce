<div class="tab-pane show active" id="grid" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
...
<div class="tab-pane" id="list" role="tabpanel" aria-labelledby="list-tab" tabindex="0">
...
<div class="community-btn">
    <a class="btn btn-sm btn-danger load-button" id="load-button" data-last_id="<?php echo $product->id; ?>">Load More</a>
</div>
