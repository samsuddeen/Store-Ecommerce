            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="general_background_style">
                        <h3 class="ms-3">Get In Touch</h3>
                        <form action="{{ route('send_inquiry') }}" method="POST" id="contactForm" class="p-2">
                            @csrf
                            ...
                            <div class="row p-2 my-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="tel" class="form-control" name="contact" id="contact" placeholder="Contact Number" value="{{ old('contact') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row p-2 my-3">
