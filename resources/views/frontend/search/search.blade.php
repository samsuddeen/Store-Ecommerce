...
@section('title', @$slug ?? 'Search Items')
@section('content')
        ...
        <div class="container">
            <div class="category-head">
                <div class="category_product_number">
                    {{-- <p><span>{{ count(@$products) }}</span> items found in {{ $cat->title }}</p> --}}
                </div>
                ...
                <div class="col-lg-3 col-md-3 cat-filter">
                    ...
                    <div class="cat_sideBar_wrap">
                        <div class="filter-list">
                            ...
                            <a class="moreless-button btns" href="#">More Colors</a>
                        </div>
                        <div class="filter-list">
                            ...
                            <form class="price_filterGroup">
                                <input type="number" name="min" id="min_price" min="0" class="form-control min"
                                    placeholder="Min">
                                <span>-</span>
                                <input type="number" name="max" id="max_price" min="0" class="form-control max"
                                    placeholder="Max">
                                <button type='button' class="submit" id="submit"><i class="las la-search"></i></button>
                            </form>
                        </div>
                        <div class="filter-list">
                            ...
                            <div id="brandsection">
                                ...
                                <a class="brandmoreless-button btns" href="#">More Brands</a>
                            </div>
                        </div>
                                ...
                                <div class="grid-view" id="product">
                                    <div class="row margin">
                                        @if (count($products) > 0)
                                                                        ...
                                                                        @if ($key == 0)
                                                                            ...
                                                                            @if ($offer != null)
                                                                                <del>${{ number_format($stock->price) }}</del><span
                                                                                    class="price_list">Rs.{{ number_format($offer) }}</span>
                                                                            @elseif($stock->special_price)
                                                                                <del>${{ number_format($stock->price) }}</del><span
                                                                                    class="price_list">Rs.{{ number_format($stock->special_price) }}</span>
                                                                            @else
                                                                                <span class="price_list">Rs.
                                                                                    {{ number_format($stock->price) }}</span>
                                                                            @endif
                                                                        @endif
                                                                    @endforeach
                                                                </div>
                                            ...
                                            @endforeach
                                        @else
                                            <h4 class="text-center">Sorry !! No Items Found...</h4>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
@push('script')
    ...
    @include('frontend.search.search-js')
@endpush
