...
@section('title','Popular Product List')
@section('content')
    ...
    <nav aria-label="breadcrumb" class="nav_breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Popular Product List</li>
            </ol>
        </div>
    </nav>
    <!-- Breadcrumb End  -->
                                                                ...
                                                                <div class="old-price-list">
                                                                    @foreach ($pro->stocks as $key => $stock)
                                                                        @if ($key == 0)
                                                                            ...
                                                                            @else
                                                                                <span
                                                                                    class="price_list">{{ $stock->price }}</span>
                                                                            @endif
                                                                        @endif
                                                                    @endforeach
                                                                </div>
...
@push('script')
    ...
    @include('frontend.product.product-detail-list')
@endpush
