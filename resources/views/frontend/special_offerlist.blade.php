...
@section('title','Secial Offer List')
@section('content')
    ...
    <nav aria-label="breadcrumb" class="nav_breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Special Offer List</li>
            </ol>
        </div>
    </nav>
    <!-- Breadcrumb End  -->
                            ...
                            <div class="tab-pane" id="list" role="tabpanel" aria-labelledby="list-tab"
                                ...
                                <div class="list-view-category product-view" id="list_view">
                                    <div class="row margin">
                                        @if(count($products) >0)
                                        @foreach ($products as $product)
                                        <div class="col-lg-6 col-md-6 col-sm-12 padding">
                                            <div class="product-col">
                                                @foreach ($product->featuredSections as $feature)
                                                    @if ($feature->title == 'on_sale')
                                                        <div class="thumbnail_sellbadge">
...
@push('script')
    ...
    @include('frontend.product.special_offerlist')
    {{-- @include('frontend.product.new-product-list') --}}
