    ...
    <section class="store-all-product mt mb">
        <div class="container">
            ...
            <div>
                ...
                <input type="hidden" name="search_field" id="search_field" value="{{ @$search_value }}">
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div class="category-main">
                            <div class="tab-content" id="seller-search-nav-tabContent">
                                <div class="tab-pane show active" id="grid" role="tabpanel"
                                    ...
                                    <div class="grid-view" id="product">
                                        <div class="row margin">
                                            ...
                                            @endforeach
                                            @else
                                            <h5 class="text-center">Sorry !! No Items Found....</h5>
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
@endsection
@push('script')
@include('frontend.seller.sellerfront.seller-search-filter-js')
@endpush