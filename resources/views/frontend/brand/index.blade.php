    ...
    <nav aria-label="breadcrumb" class="nav_breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ @$slug }}</li>
            </ol>
        </div>
    </nav>
    <!-- Breadcrumb End  -->
        ...
        <div class="container">
            <div class="category-head">
                <div class="category_product_number">
                    @if(@$brand!=null)
                    <p><span>{{ count(@$products) ?? 0 }}</span> items found in {{ $brand->name }}</p>
                    @endif
                </div>
                                                                    ...
                                                                    <div class="old-price-list">
                                                                        @foreach ($pro->stocks as $key => $stock)
                                                                            @if ($key == 0)
                                                                                ...
                                                                                @endphp
                                                                                @if ($offer != null)
                                                                                    <del class="enable-del">{{ $stock->price }}</del><span
...
@push('script')
    ...
    @include('frontend.brand.brand-filter')
@endpush
