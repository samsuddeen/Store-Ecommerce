            ...
            @foreach ($new_arrival->stocks as $key => $stock)
                @if ($key == 0)
                    @php
                        ...
                        $retailerLoginStatus=checkRetailerLoginStatus();
                        // if($retailerLoginStatus){
                        //     $retailerPrice=checkRetailerPrice($stock,$stock->price,$stock->special_price,$offer,$retailerLoginStatus);
                        // }else{
                        //     $retailerPrice=null;
                        // }
                    @endphp
