                            ...
                            <div class="order-tracking-table-list">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Amount</th>
                                            <td>{{@$seller_order_details->sum('sub_total')+@$seller_order->total_discount}}</td>
                                        </tr>
                                        <tr>
                                            <th>Discount</th>
                                            <td>{{@$seller_order->total_discount}}</td>
                                        </tr>
                                        @if(@$seller_order->total_vat_amount > 0 && @$seller_order->total_vat_amount !=null)
                                            <th>Vat</th>
                                            <td>{{@$seller_order->total_vat_amount}}</td>
                                        @endif
                                        @if(@$admin)
                                        <tr>
                                        ...
                                        <tr>
                                            <th>Total</th>
                                            <td>{{@$seller_order_details->sum('sub_total')+@$seller_order->total_vat_amount}}</td>
                                        </tr>
                                        @endif
