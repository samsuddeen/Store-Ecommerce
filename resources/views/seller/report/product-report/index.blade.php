@extends('layouts.app')
@section('title', env('DEFAULT_TITLE') . ' | ' . 'Seller | Searchreport')
@push('style')
    <style>
        td img {
        ...
        <div class="row" id="table-bordered">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card mb-0">
                        <div class="card-body mid-body m-0 scv-buttons-all">
                    <div class="btn-bulk">
                        <a href="{{route('sellerproductreportexcel')}}" class="global-btn pdfbilled" style="margin-left:5px;">Export
                            (CSV)</a>
                    </div>
                </div>
            </div>
...
<script>
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('seller.productreport') }}",
            data: function(d) {
